...
export const FiledEmail = styled.input.attrs({
    ...
    &:focus{
        ...
        box-shadow: 1px 1px 2px 0 ${props => props.color === '' ? 'blue' : 'red'}; 
    }
`;
...
export const ButtonAuthSubmit = styled.button.attrs({
    ...
    font: 13px/18px haas,pragmatica,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Arial,sans-serif;
    font-style: normal;
    border-radius: 4px;
    ...
    margin:3px;
    padding: 5px;
    font-family: haas, pragmatica, -apple-system, BlinkMacSystemFont, Roboto, "Helvetica Neue", Arial, sans-serif;
    &:hover{
